...
<head>
    ...
    <title>Task Management App Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-tasks">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-tasks">
                                <a href="#endpoints-POSTapi-tasks">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-tasks--id-">
                                <a href="#endpoints-GETapi-tasks--id-">Display the specified resource.</a>
                            </li>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="abagail57@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>abagail57@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 6 characters. Example: <code>!Jg!;UQ13nxC</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"name\": \"pkslvpervrndyfdp\",
    \"email\": \"krajcik.allie@example.net\",
    \"password\": \"J\'VZdaB\\\\\\\"2PQC(\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="pkslvpervrndyfdp"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>pkslvpervrndyfdp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="krajcik.allie@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>krajcik.allie@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 6 characters. Example: <code>J'VZdaB\"2PQC(</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-tasks">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-tasks">Store a newly created resource in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="wvlojyercwrahtet"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>wvlojyercwrahtet</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>fugiat</code></p>
                    ...
                    <h2 id="endpoints-GETapi-tasks--id-">Display the specified resource.</h2>
